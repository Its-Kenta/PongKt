...
import com.github.kenta.pongkt.source.utils.Utils.createFlashingText
import com.github.kenta.pongkt.source.utils.WINDOW_HEIGHT
import com.github.kenta.pongkt.source.utils.WINDOW_WIDTH
import com.github.kenta.pongkt.source.entities.*
            ...
            when (currentState) {
                ...
                GameState.SCORED -> {
                    if (pScored && playerScore != 4u) {
                        createFlashingText(it, AssetManager.standardGameFont, "YOU SCORED! PRESS SPACE TO SERVE!", Vector2(
                        ...
                        createFlashingText(it, AssetManager.standardGameFont, "AI SCORED! PRESS SPACE TO CONTINUE!", Vector2(
                            WINDOW_WIDTH.toFloat()/2 - 197, WINDOW_HEIGHT.toFloat()/2 + 150))
                ...
                GameState.OUTCOME -> {
                    ...
                    if (aiScore == 4u) {
                        createFlashingText(it, AssetManager.standardGameFont, "YOU LOST! PRESS SPACE TO RESTART!", Vector2(
                            WINDOW_WIDTH.toFloat()/2 - 197, WINDOW_HEIGHT.toFloat()/2 + 150))
                    } else {
                        createFlashingText(it, AssetManager.standardGameFont, "YOU WON! PRESS SPACE TO RESTART!", Vector2(
                            WINDOW_WIDTH.toFloat()/2 - 197, WINDOW_HEIGHT.toFloat()/2 + 150))
                    }
